...
namespace QLDSV
{
    public partial class SVDKLTC : DevExpress.XtraEditors.XtraForm
    {
        public SVDKLTC()
        {
            InitializeComponent();
        ...
        private void SVDKLTC_Load(object sender, EventArgs e)
        {
        ...
        private void btnIn_Click(object sender, EventArgs e)
        {
            ...
            rpSVDKLTC rpt = new rpSVDKLTC(nienkhoa, hocky, nhom, monhoc);
